          ...
          <div className="bg-white rounded-3xl p-8 sm:p-10 border border-zinc-200 shadow-xl space-y-6 w-full">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-zinc-500 leading-relaxed max-w-md mx-auto">
                Tuning mathematical scoring weights, inspecting RBAC permissions, and performing database resets requires Platform Admin authentication.
              </p>
            </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-8">
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-xs font-bold text-zinc-700 bg-zinc-100 px-3 py-1 rounded-full border border-zinc-200">
                Logged in as: <span className="text-emerald-700">{currentUser.name} ({currentUser.email})</span>
              </div>
            </div>
