...
import { Deal, Store } from '@/shared/types';
import { 
  loadDeals, 
  loadStores, 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">
                Real-time inventory clearance, explainable pricing telemetry &amp; ESG impact tracking.
              </p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-8">
        {/* Section 10: Financial & Sustainability Telemetry Cards */}
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-bold text-base text-zinc-900">Operational &amp; ESG Telemetry (FR-DASH)</h2>
              <p className="text-xs text-zinc-500">Computed live across all counter sales &amp; rescued items</p>
            </div>
